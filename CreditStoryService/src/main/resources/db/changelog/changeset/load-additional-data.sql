...
VALUES (1, 2, 'CC1011', '2024-01-01', '2027-01-01', 200000.00, 'RUB', 11.50, 'АКТИВЕН'),
       (2, 1, 'CC1012', '2023-07-15', '2026-07-15', 150000.00, 'RUB', 10.25, 'АКТИВЕН'),
       (3, 2, 'CC1013', '2022-02-01', '2025-02-01', 300000.00, 'RUB', 9.75, 'ПРОСРОЧЕН');

INSERT INTO payment_schedule (contract_id, payment_date, payment_amount, principal_amount, interest_amount, status)
VALUES
-- Contract CC1011
(11, '2024-06-01', 18000.00, 15000.00, 3000.00, 'ОЖИДАЕТСЯ'),
(11, '2024-07-01', 18000.00, 15000.00, 3000.00, 'ОЖИДАЕТСЯ'),

-- Contract CC1012
(12, '2024-05-01', 10000.00, 8500.00, 1500.00, 'ОПЛАЧЕН'),
(12, '2024-06-01', 10000.00, 8500.00, 1500.00, 'ОЖИДАЕТСЯ'),

-- Contract CC1013
(13, '2023-12-01', 12000.00, 10000.00, 2000.00, 'ПРОПУЩЕН'),
(13, '2024-01-01', 12000.00, 10000.00, 2000.00, 'ПРОПУЩЕН');
