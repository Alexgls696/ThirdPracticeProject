...
VALUES (1, 1, 'CC1001', '2023-01-01', '2026-01-01', 500000.00, 'RUB', 12.50, 'АКТИВЕН'),
       (2, 2, 'CC1002', '2022-05-15', '2025-05-15', 300000.00, 'RUB', 10.00, 'АКТИВЕН'),
       (3, 3, 'CC1003', '2021-03-10', '2024-03-10', 450000.00, 'RUB', 11.25, 'ЗАКРЫТ'),
       (4, 1, 'CC1004', '2023-08-01', '2026-08-01', 700000.00, 'RUB', 13.00, 'АКТИВЕН'),
       (5, 2, 'CC1005', '2022-11-20', '2025-11-20', 250000.00, 'RUB', 9.75, 'ПРОСРОЧЕН'),
       (6, 1, 'CC1006', '2023-04-01', '2026-04-01', 600000.00, 'RUB', 12.00, 'АКТИВЕН'),
       (7, 3, 'CC1007', '2021-09-15', '2024-09-15', 550000.00, 'RUB', 10.50, 'ЗАКРЫТ'),
       (8, 2, 'CC1008', '2022-06-01', '2025-06-01', 400000.00, 'RUB', 11.00, 'АКТИВЕН'),
       (9, 3, 'CC1009', '2020-12-01', '2023-12-01', 350000.00, 'RUB', 9.50, 'ЗАКРЫТ'),
       (10, 1, 'CC1010', '2023-02-01', '2026-02-01', 800000.00, 'RUB', 13.25, 'АКТИВЕН');

-- Insert into payment_schedule
INSERT INTO payment_schedule (contract_id, payment_date, payment_amount, principal_amount, interest_amount, status)
VALUES (1, '2024-06-01', 15000.00, 12000.00, 3000.00, 'ОЖИДАЕТСЯ'),
       (1, '2024-07-01', 15000.00, 12000.00, 3000.00, 'ОЖИДАЕТСЯ'),
       (2, '2024-06-15', 12000.00, 10000.00, 2000.00, 'ОЖИДАЕТСЯ'),
       (2, '2024-07-15', 12000.00, 10000.00, 2000.00, 'ОЖИДАЕТСЯ'),
       (3, '2024-03-10', 15000.00, 13000.00, 2000.00, 'ОПЛАЧЕН'),
       (4, '2024-06-01', 17000.00, 14000.00, 3000.00, 'ОЖИДАЕТСЯ'),
       (5, '2024-05-20', 10000.00, 8000.00, 2000.00, 'ПРОПУЩЕН'),
       (6, '2024-06-01', 16000.00, 13000.00, 3000.00, 'ОЖИДАЕТСЯ'),
       (7, '2024-02-15', 14000.00, 11000.00, 3000.00, 'ОПЛАЧЕН'),
       (8, '2024-06-01', 13000.00, 10000.00, 3000.00, 'ОЖИДАЕТСЯ'),
       (9, '2023-12-01', 12000.00, 10000.00, 2000.00, 'ОПЛАЧЕН'),
       (10, '2024-06-01', 18000.00, 15000.00, 3000.00, 'ОЖИДАЕТСЯ');
