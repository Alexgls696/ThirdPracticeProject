...
VALUES
    (1, '2023-09-01', 16000.00, 13000.00, 3000.00, 'ОПЛАЧЕН'),
    (1, '2023-10-01', 16000.00, 13000.00, 3000.00, 'ОПЛАЧЕН'),
    (1, '2023-11-01', 16000.00, 13000.00, 3000.00, 'ПРОПУЩЕН'),
    (1, '2023-12-01', 16000.00, 13000.00, 3000.00, 'ОПЛАЧЕН'),
    (1, '2024-01-01', 16000.00, 13000.00, 3000.00, 'ПРОПУЩЕН');
